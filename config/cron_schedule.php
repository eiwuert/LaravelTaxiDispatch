...
$con=mysqli_connect("localhost","root","admin","goapp");
...
$date1 = date("Y-m-d");
$qry = mysqli_query($con,"select r.*,c.mobile,ct.capacity from wy_ride r join wy_customer c on c.id=r.customer_id join wy_cartype ct on ct.id=r.car_type where r.ride_type=2 and r.ride_status=0 and r.schedule_date='$date1'");
