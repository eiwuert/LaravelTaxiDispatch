...
<div class="rightside bg-grey-100">
			<!-- BEGIN PAGE HEADING -->
            <div class="page-head">
				<h1 class="page-title"><?php echo e(trans('config.lbladd_offer')); ?></h1>
				<!-- BEGIN BREADCRUMB -->
            ...
            <div class="container-fluid">
				<div class="row">
					<div class="col-lg-12">
						...
						<?php if(Session::has('error_offers')): ?>
						<div class="alert alert-danger"><strong><?php echo e(Session::get('error_offers')); ?></strong></div>
						...
						<div class="alert alert-success text-center" id="info">Select a coupon category</div>
                           ...
                           <div class="panel">
                            <div class="panel-title bg-grey-300">
								<div class="panel-head"><?php echo e(trans('config.lbl_offer_manage')); ?></div>
							</div>
									...
									<div class="col-sm-4">
									 <select class="form-control" name="VehicleCategory" id="VehicleCategory">
							          <option value="">--Select Type--</option>
							            <?php $__currentLoopData = $ride_type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ride): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
									  <option value="<?php echo e($ride->id); ?>" ><?php echo e($ride->ride_category); ?></option>
