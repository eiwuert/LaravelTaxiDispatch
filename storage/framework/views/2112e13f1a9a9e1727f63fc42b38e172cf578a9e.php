...
<div class="expt_btn pull-right">
 <a href="<?php echo e(Request::fullUrl()); ?><?php echo e($estatus); ?>" <?php if(count($cancelled_list)== 0): ?> <?php echo e("disabled=disabled"); ?><?php endif; ?> class="margin-bottom-20 btn btn-dark bg-red-600 color-white">Download EXCEL</a> <a href="<?php echo e(Request::fullUrl()); ?><?php echo e($pestatus); ?>" <?php if(count($cancelled_list)== 0): ?> <?php echo e("disabled=disabled"); ?><?php endif; ?>  class="margin-bottom-20 btn btn-dark bg-red-600 color-white">Download PDF</a>
</div>
</div>
...
<script>
 ...
 AmCharts.makeChart( "vehiecle_ride_details", {
  ...
  "titles": [
	...
	"dataProvider": [ 
						<?php if(count($cancelled_ride_graph) > 0): ?>
					  <?php $__currentLoopData = $cancelled_ride_graph; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ride_details): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
			  			{
