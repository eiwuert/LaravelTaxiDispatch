<div class="rightside bg-grey-100">
        ...
        $total_company_share = number_format($total_company_share, 2, '.', ',');  
        $total_driver_share = number_format($total_driver_share, 2, '.', ',');   

         ?> 
<div class="page-head bg-grey-100">
				<h1 class="page-title"><?php echo e(Config::get('common.dashboard')); ?></h1>
                <div class="btn bg-grey-600 padding-10-20 no-border color-white pull-right border-radius-5 hidden-xs no-shadow margin-left-10">Total Company Balance<i class="fa fa-rupee margin-left-10 "></i> <span><strong><?php echo e($total_company_share); ?></strong></span></div>
                <div class="btn bg-yellow-600 padding-10-20 no-border pull-right border-radius-5 hidden-xs no-shadow margin-left-10">Total Drivers Share Amount<i class="fa fa-rupee margin-left-10 "></i> <span><strong><?php echo e($total_driver_share); ?></strong></span></div>
			</div>
					...
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
						<div class="panel bg-grey-500">
							<div class="panel-body padding-15-20">
								<div class="clearfix">
									<div class="pull-left">
										<div class="color-white font-size-26 font-roboto font-weight-600" data-toggle="counter" data-start="0" data-from="0" data-to="143" data-speed="500" data-refresh-interval="10"><?php echo e(count($total_drivers)); ?></div>
					...
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
						<div class="panel bg-deep-orange-400">
							<div class="panel-body padding-15-20">
								<div class="clearfix">
									<div class="pull-left">
										<div class="color-white font-size-26 font-roboto font-weight-600" data-toggle="counter" data-start="0" data-from="0" data-to="10" data-speed="500" data-refresh-interval="10"><?php echo e(count($total_cars)); ?> </div>
					...
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
						<div class="panel bg-blue-400">
							<div class="panel-body padding-15-20">
								<div class="clearfix">
									<div class="pull-left">
										<div class="color-white font-size-26 font-roboto font-weight-600" data-toggle="counter" data-start="0" data-from="0" data-to="43" data-speed="500" data-refresh-interval="10"><?php echo e(count($today_wryde)); ?></div>
												 ...
												 <tr>
													...
													<td  width='50%'> <select class="chosen-select-deselect form-control" name="vehicle-number" >
															<option value="">ALL</option>
															 <?php $__currentLoopData = $active_vehicles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vehicle): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
															  <option value="<?php echo e($vehicle->vehicle_id); ?>" <?php echo e(session('d_vehiclenum') == $vehicle->vehicle_id ? "selected=selected":''); ?> ><?php echo e($vehicle->car_no); ?> - <?php echo e($vehicle->car_type); ?> (<?php echo e($vehicle->car_board); ?>) </option>
            ...
            <div class="row">
                <div class="col-lg-12">
					...
					<!--<h3 class="color-grey-700">Individual Drivers Total Share and Company Profit</h3>-->
													<div class="col-lg-12 ">	
														<h4 class="color-grey-700">Individual Drivers Total Share Amount</h4>		
														<div id="driver_profit" style="height:600px;"></div>
...
<!-- dashboard -->
		...
		<?php echo $__env->make('dashboard.report', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
