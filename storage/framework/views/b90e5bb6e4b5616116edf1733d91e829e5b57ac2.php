                                ...
                                <div id="franchise">
                                    <div class="form-group">
                                        ...
                                        <select class="chosen-select-deselect form-control" name="franchise" id="franchise_select">
                                            ...
                                            <option value="<?php echo e($r->id); ?>"><?php echo e($r->company_name); ?></option>
                                ...
                                <div class="form-group  <?php echo e($errors->has('country')? 'has-error':''); ?>">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control validate" name="ridetype" id="VehicleCategory">
                                            ...
                                            <?php $__currentLoopData = $ridetype; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                            <option value="<?php echo e($r->id); ?>"><?php echo e($r->ride_category); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                                        </select>
                                ...
                                <div class="form-group  <?php echo e($errors->has('country')? 'has-error':''); ?>">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control validate" name="country" id="country">
                                            ...
                                            <option value="<?php echo e($country->id); ?>" <?php if (old('country') == $country->id) {
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <select name="taxi_type" id="VehicleType" class="form-control validate">
                                            ...
                                            <option value="<?php echo e($car_types->id); ?>"><?php echo e($car_types->car_type); ?>

                                <?php if($car_types->car_board == 1): ?> (W) <?php endif; ?>
                                <?php if($car_types->car_board == 2): ?> (Y) <?php endif; ?>
                                            </option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                                        </select>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <select name="taxi_brand" id="VehicleBrand" class="form-control validate">
                                            ...
                                            <option value="<?php echo e($car_brands->id); ?>"><?php echo e($car_brands->brand); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                                        </select>
                                    </div>
                                </div>
