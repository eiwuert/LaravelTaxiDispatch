...
<div class="page-head bg-grey-100">
				<!-- <h1 class="page-title"><?php echo e(Config::get('common.dashboard')); ?><small>Welcome to WrydesDispatch administration</small></h1> -->
				
                <div class="btn bg-grey-600 padding-10-20 no-border color-white pull-right border-radius-5 hidden-xs no-shadow margin-left-10">Total Franchise balance<i class="fa fa-dollar margin-left-10 "></i> <span><strong><?php echo e($franchise_share); ?></strong></span></div>
                <div class="btn bg-yellow-600 padding-10-20 no-border pull-right border-radius-5 hidden-xs no-shadow margin-left-10">Total Drivers Share Amount<i class="fa fa-dollar margin-left-10 "></i> <span><strong><?php echo e($total_driver_share); ?></strong></span></div>
			</div>
					...
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
						<div class="panel bg-blue-400">
							<div class="panel-body padding-15-20">
								<div class="clearfix">
									<div class="pull-left">
										<div class="color-white font-size-26 font-roboto font-weight-600" data-toggle="counter" data-start="0" data-from="0" data-to="43" data-speed="500" data-refresh-interval="10"><?php echo e($today_wryde[0]->ride_count); ?></div>
