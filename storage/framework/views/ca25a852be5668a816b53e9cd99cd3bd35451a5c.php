				...
				<div class="row">
					<div class="col-lg-12">
                           <div class="panel">
							...
							<?php $__currentLoopData = $brand_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
								<form class="form-horizontal" action="" role="form" method="post">
								  ...
								  <div class="form-group <?php echo e($errors->has('brand_name')? 'has-error':''); ?>">
									...
									<div class="col-sm-4">
									  <input type="text" class="form-control" id="brand" name="brand_name" maxlength="20" value ="<?php echo e(old('brand_name',$brand->brand)); ?>" placeholder="" >
