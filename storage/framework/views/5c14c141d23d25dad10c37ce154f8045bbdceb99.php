...
Successful Rides Report - Go Cabs
...
<?php endif; ?>
 <div class="rightside bg-grey-100">
			<!-- BEGIN PAGE HEADING -->
           <!--  <div class="page-head">
				<h1 class="page-title">Successful Rides Details</h1>
			</div> -->
			<!-- END PAGE HEADING -->
            ...
            <div class="container-fluid">
             ...
             <div class="panel">
              <div class="panel-title bg-amber-200">
								<div class="panel-head">Successful Rides Report</div>
							</div>
        ...
        <div class="col-lg-12">
			...
			<div class="form-horizontal" >
                ...
                <div class="form-group margin-bottom-20 col-md-3 pull-right" style=" right: -17px; position: relative;">
          				...
          				<button type="button" class="btn btn-dark bg-grey-400 color-black" onclick="window.parent.location='<?php echo e(URL::to('/cancel_rides')); ?>'" >Reset</button>
          		</div> 
...
<div class="expt_btn pull-right">
 <a href="<?php echo e(Request::fullUrl()); ?><?php echo e($estatus); ?>" <?php if(count($success_list)== 0): ?> <?php echo e("disabled=disabled"); ?><?php endif; ?> class="margin-bottom-20 btn btn-dark bg-red-600 color-white">Download EXCEL</a> <a href="<?php echo e(Request::fullUrl()); ?><?php echo e($pestatus); ?>" <?php if(count($success_list)== 0): ?> <?php echo e("disabled=disabled"); ?><?php endif; ?>  class="margin-bottom-20 btn btn-dark bg-red-600 color-white">Download PDF</a>
</div>
</div>
...
<tr valign="top" align="center">
	...
	<th align="left">Driver's Share</th>
	<th align="left">Franchise Share</th>
	<?php if($franchise_id == 0): ?><th align="left">Company Share</th><?php endif; ?>
</tr>
<tr>
...
<script>
 ...
 AmCharts.makeChart( "vehiecle_ride_details", {
  ...
  "titles": [
	...
	"dataProvider": [ 
						<?php if(count($success_ride_graph) > 0): ?>
					  <?php $__currentLoopData = $success_ride_graph; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ride_details): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
			  			{
