                        ...
                        <div class="tab-content">
                            <div id="fontawesome" aria-labelledBy="fontawesome-tab"
                                ...
                                <table class="table table-bordered display" id="mvvulticheck_active">
                                    ...
                                    <tbody>
                                    <?php $__currentLoopData = $adata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                    <tr>
                                        <!-- <td class="vertical-middle">
                                            
                                            <input type="checkbox" class="checkf" name="checkbox[]" value="<?php echo e($d->id); ?>">
                                            
                                        </td> -->
                                        <td class="vertical-middle"><?php echo e($d->name); ?></td>
                                        <td class="vertical-middle"><?php echo e($d->mobile); ?></td>
                                        <td class="vertical-middle"><?php echo e($d->email); ?></td>
                                        <td class="vertical-middle ">
                                            <a  onclick="deactivate(<?php echo e($d->id); ?>,'blockcustomer','Customer');" title="Block" class="" ><i class="fa fa-close fa-2x"></i></a>
                                        </td>
                                    </tr>
                                ...
                                <!-- <div class="form-group ">
                                    ...
                                    <div class="col-sm-2 ">
                                   <button id="btn_block" class="btn btn-danger" <?php if(count($adata)==0): ?> <?php echo e('disabled=disabled'); ?> <?php endif; ?> >Change</button>
                                  </div>
                                  </div> -->
                            ...
                            <div id="ionicons" aria-labelledBy="ionicons-tab"
                                ...
                                <table class="table table-bordered display" id="gmulticheck_inactive" >
                                    ...
                                    <tbody>
                                    <?php $__currentLoopData = $bdata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                    <tr>
                                        <!-- <td class="vertical-middle">
                                        ...
                                        <td class="vertical-middle"><?php echo e($d->email); ?></td>
                                        <td class="vertical-middle ">
                                            <a  onclick="activate(<?php echo e($d->id); ?>,'activatecustomer','Customer');" title="Activate"  class="" ><i class="fa fa-check fa-2x"></i></a>
                                        </td>
                                    </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                                ...
                                <p class="text-light margin-bottom-30"></p>
                                    ...
                                    <button id="btn_delete" class="btn btn-danger" <?php if(count($bdata)==0): ?> <?php echo e('disabled=disabled'); ?> <?php endif; ?> >Change</button>
