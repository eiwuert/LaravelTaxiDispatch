                           ...
                           <div class="panel">
                            ...
                            <div class="panel-body">
								<form class="form-horizontal" role="form" method="POST" enctype="multipart/form-data">
                                 ...
                                 <?php echo e(csrf_field()); ?>
								   ...
								   <div class="form-group <?php echo e($errors->has('ride_category')? 'has-error':''); ?>" >
									...
									<div class="col-sm-4">
									  <input type="text" maxlength="20" class="form-control validate" id="car_type" value ="<?php echo e(old('car_type')); ?>" name="car_type" placeholder="" required >
									...
									<div class="form-group  <?php echo e($errors->has('taxi_capacity')? 'has-error':''); ?>">
										...
										<div class="col-sm-4">
											<input type="text" class="form-control validate numeric" value="<?php echo e(old('taxi_capacity')); ?>" id=""
								...
								<div class="form-group <?php echo e($errors->has('companydriver_share')? 'has-error':''); ?>">
									...
									<div class="col-sm-4">
									  <input type="text" class="form-control validate numeric" id="companydriver_share" value ="<?php echo e(old('companydriver_share')); ?>" maxlength="3" name="companydriver_share" placeholder="" required >
								...
								<div class="form-group <?php echo e($errors->has('attacheddriver_share')? 'has-error':''); ?>">
									...
									<div class="col-sm-4">
									  <input type="text" class="form-control validate numeric" id="attacheddriver_share" value ="<?php echo e(old('attacheddriver_share')); ?>" maxlength="3" name="attacheddriver_share" placeholder="" required > 
								...
								<div class="form-group <?php echo e($errors->has('franchise_share')? 'has-error':''); ?>">
									...
									<div class="col-sm-4">
									  <input type="text" class="form-control validate numeric" id="franchise_share" value ="<?php echo e(old('franchise_share')); ?>" maxlength="3" name="franchise_share" placeholder="" required > 
