...
<?php endif; ?>
 <div class="rightside bg-grey-100">
			<!-- BEGIN PAGE HEADING -->
            <!-- <div class="page-head">
				<h1 class="page-title">Rejected Rides Details</h1>
            ...
            <div class="container-fluid">
             ...
             <div class="panel">
              <div class="panel-title bg-amber-200">
								<div class="panel-head">Rejected Rides Report</div>
							</div>
        ...
        <div class="col-lg-12">
			...
			<div class="form-horizontal" >
                ...
                <div class="form-group margin-bottom-20 col-md-3 pull-right" style=" right: -17px; position: relative;">
          				...
          				<button type="button" class="btn btn-dark bg-grey-400 color-black" onclick="window.parent.location='<?php echo e(URL::to('/reject_rides')); ?>'" >Reset</button>
          		</div> 
...
<div class="expt_btn pull-right">
 <a href="<?php echo e(Request::fullUrl()); ?><?php echo e($estatus); ?>" <?php if(count($rejected_list)== 0): ?> <?php echo e("disabled=disabled"); ?><?php endif; ?> class="margin-bottom-20 btn btn-dark bg-red-600 color-white">Download EXCEL</a> <a href="<?php echo e(Request::fullUrl()); ?><?php echo e($pestatus); ?>" <?php if(count($rejected_list)== 0): ?> <?php echo e("disabled=disabled"); ?><?php endif; ?>  class="margin-bottom-20 btn btn-dark bg-red-600 color-white">Download PDF</a>
</div>
</div>
...
<script>
 ...
 AmCharts.makeChart( "vehiecle_ride_details", {
  ...
  "titles": [
	...
	"dataProvider": [ 
						<?php if(count($rejected_ride_graph) > 0): ?>
					  <?php $__currentLoopData = $rejected_ride_graph; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ride_details): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
			  			{
