                           ...
                           <div class="panel">
							...
							<div class="panel-body">
								...
								<div class="form-group {{ $errors->has('tax_name')? 'has-error':'' }}">
									...
									<div class="col-sm-4">
									  <input type="text" maxlength="30" class="form-control" id="tax_name" value ="{{old('tax_name')}}" name="tax_name" placeholder="" required > 
                                 ...
                                 <div class="form-group {{ $errors->has('tax_percentage')? 'has-error':'' }}">
									...
									<div class="col-sm-4">
									  <input type="text" class="form-control number" id="tax_percentage" value ="{{old('tax_percentage')}}" maxlength="5" name="tax_percentage" placeholder="" required > 
