...
<!-- END HEAD -->
<!-- BEGIN BODY -->
<body class="auth-page height-auto" style="background:url({{ URL::asset('public/assets/img/bg.jpg')}}) no-repeat center; background-size:cover;	" >
	<!-- BEGIN CONTENT -->
	<div class="wrapper animated fadeInDown">
		<div class="panel overflow-hidden">
			<div class="bg-white padding-top-25 no-margin-bottom font-size-20 color-white text-center text-uppercase">
				<img src="{{ URL::asset("public/assets/img/logo-new.png") }}">
			</div>
