...
<div class="rightside bg-grey-100">
			<!-- BEGIN PAGE HEADING -->
            <div class="page-head">
				<h1 class="page-title">{{ trans('config.lblr_update_rating') }}</h1>
				<!-- BEGIN BREADCRUMB -->
								...
								<form class="form-horizontal" action="" role="form" method="post">
								  ...
								  <div class="form-group {{ $errors->has('rating_id')? 'has-error':'' }}">
								   ...
								   <div class="form-group {{ $errors->has('rating_reason')? 'has-error':'' }}">
									...
									<div class="col-sm-4">
									  <input type="text" class="form-control" id="rating_reason" name="rating_reason" value ="{{old('rating_reason')}}" placeholder="" >
