                           ...
                           <div class="panel">
                            ...
                            <div class="panel-body">
								...
								<form class="form-horizontal" role="form" method="POST"  enctype="multipart/form-data">
                                  <input type="hidden" name="type_id" value="{{$car_type->id}}"/>
								  ...
								  <div class="form-group {{ $errors->has('ride_category')? 'has-error':'' }}" >
									...
									<div class="col-sm-4">
									  <select class="form-control" name="ride_category" id="vehicle_category" disabled>
                                        ...
                                        @if($cat->id == $car_type->ride_category)
									  <option value="{{$cat->id}}" >{{$cat->ride_category}}</option>
									  @endif
									 @endforeach
                                      </select>
									</div>
									...
									<div class="col-sm-4">
									  <input type="text" maxlength="20" class="form-control" id="car_type" value ="{{old('car_type',$car_type->car_type)}}" name="car_type" placeholder="" required >
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control numeric" value="{{$car_type->capacity}}" id=""
                                ...
                                <?php if($car_type->ride_category == 1){
									...
									<div class="col-sm-4">
									  <input type="text" class="form-control numeric" id="companydriver_share" value ="{{old('companydriver_share',$car_type->companydriver_share)}}" maxlength="3" name="companydriver_share" placeholder="" required >
								...
								<div class="form-group {{ $errors->has('attacheddriver_share')? 'has-error':'' }}">
									...
									<div class="col-sm-4">
									  <input type="text" class="form-control numeric" id="attacheddriver_share" value ="{{old('attacheddriver_share',$car_type->attacheddriver_share)}}" maxlength="3" name="attacheddriver_share" placeholder="" required > 
								...
								<div class="form-group {{ $errors->has('franchise_share')? 'has-error':'' }}">
									...
									<div class="col-sm-4">
									  <input type="text" class="form-control numeric" id="franchise_share" value ="{{old('franchise_share',$car_type->franchise_share)}}" maxlength="3" name="franchise_share" placeholder="" required > 
								   ...
								   <div class="form-group ">
										...
										<div class="col-sm-4">
                                        <img src="{{ URL::asset('public'.$car_type->yellow_caricon)}}" class="img-responsive"/>
                                        </div>
								  </div>
								  ...
								  <div class="form-group ">
                                        <label for="" class="col-sm-2 control-label"></label>
										<div class="col-sm-4">
                                        <img src="{{ URL::asset('public'.$car_type->grey_caricon)}}" class="img-responsive"/>
                                        </div>
								  </div>
								...
								<!-- <div class="form-group ">
                                        <label for="" class="col-sm-2 control-label"></label>
										<div class="col-sm-4">
                                        <img src="{{ URL::asset('public'.$car_type->black_caricon)}}" class="img-responsive"/>
                                        </div>
								  </div> -->
