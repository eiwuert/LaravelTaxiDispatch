...
<div class="page-head bg-grey-100">
				<h1 class="page-title">{{ Config::get('common.dashboard') }}</h1>
                <div class="btn bg-grey-600 padding-10-20 no-border color-white pull-right border-radius-5 hidden-xs no-shadow margin-left-10">Total Company Balance<i class="fa fa-rupee margin-left-10 "></i> <span><strong>{{$total_company_share}}</strong></span></div>
                <div class="btn bg-yellow-600 padding-10-20 no-border pull-right border-radius-5 hidden-xs no-shadow margin-left-10">Total Drivers Share Amount<i class="fa fa-rupee margin-left-10 "></i> <span><strong>{{$total_driver_share}}</strong></span></div>
			</div>
